...
class TransactionList extends React.Component {
    ...
    onSubmit = (values) => {
        ...
        console.log('onsubmit trans', this)
    ...
    renderEditTransaction(transaction) {
        return (
            <form className="item" key={transaction._id} onSubmit={this.props.handleSubmit(this.onSubmit)}>
                {this.renderEditAndDelete(transaction)}
                <div className="content">
                    Type: {transaction.type}
                    <div className="source">Source: {transaction.source}</div>
    ...
    renderTransaction(transaction) {
        console.log('editting', transaction.editting)
